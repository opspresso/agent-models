...
`manifest.json` is generated by `pnpm build` from the icon files. The viewer reads it so
makers without an icon use initials without requesting a missing asset.
